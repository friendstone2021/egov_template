...
public class UserController {
     ...
     *
     * @param tbCmUser the user information to be registered, validated using @Valid annotation
    ...
    public ModelAndView insertUserJoin(@ModelAttribute @Valid TbCmUser tbCmUser) {
        ModelAndView mv = new ModelAndView("jsonView");

        if(tbCmUser != null) {
			userService.insertUser(tbCmUser);
			mv.addObject("status", "SUCCESS");
